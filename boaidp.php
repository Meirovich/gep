...
class block_boaidp extends block_base {
    ...
    */
    ...
    {     case "2": //si $i=2 entoces haz ...
    	  ...
    	  $this->content->text= $OUTPUT->single_button($N01,"suma").$OUTPUT->single_button($N02,"resta")
          .$OUTPUT->single_button($N03,"divición");
    	  $this->content->footer = "";
    	   break;
    
    	    case "3":// lo mismo pero para $i=3
    	    $N11= new moodle_url('www.gmail.com');
    	    $N12= new moodle_url('www.gmail.com');
    	    $N13= new moodle_url('www.gmail.com');
    	
    	    $this->content->text= $OUTPUT->single_button($N11,"aguda").$OUTPUT->single_button($N12,"grave")
           .$OUTPUT->single_button($N13,"esdrujula");
    	    $this->content->footer="";
    	  
    	    break;
    	
    	    case "4":// lo mismo pero para $i=3
    		$N21= new moodle_url('www.gmail.com');
    		$N22= new moodle_url('www.gmail.com');
    		$N23= new moodle_url('www.gmail.com');
    		
    		$this->content->text= $OUTPUT->single_button($N21,"atomos"). $OUTPUT->single_button($N22,"harrypotter")
    		.$OUTPUT->single_button($N23,"eitan");
    		$this->content->footer="";
    	
    		break;
    	default: 
    		$this->content->text= "no hay nada";
    		break;
